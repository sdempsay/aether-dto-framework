...
- Collection **filtered query** on the core store remains deferred (wishlist **T8** / [#7](https://github.com/sdempsay/aether-dto-framework/issues/7)). Unfiltered **`list`** is on `AetherResourceStore` (T9 / [#11](https://github.com/sdempsay/aether-dto-framework/issues/11)).
...
| List/query | **`list(onError, principal)`** unfiltered on `AetherResourceStore` (T9 / [#11](https://github.com/sdempsay/aether-dto-framework/issues/11)): empty → empty list, order by id. Filtered query → T8 / [#7](https://github.com/sdempsay/aether-dto-framework/issues/7) |
...
- **Read-all / list** (unfiltered): done — `AetherResourceStore.list` (T9 / [#11](https://github.com/sdempsay/aether-dto-framework/issues/11)).
- Explore GraphQL and/or other **generic frontend query** approaches **once a filter port exists** — reminder only: [issue #7](https://github.com/sdempsay/aether-dto-framework/issues/7) / TODO **T8**.
